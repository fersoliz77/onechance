...
export const PROFILE_FIELD_MATRIX: Record<Role, { editable: string[]; required: string[]; public: string[] }> = {
  player: {
    editable: ['fullName', 'bio', 'position', 'nationality', 'currentClub', 'height', 'weight', 'strongFoot', 'characteristics', 'languages', 'career', 'social', 'avatarUrl', 'coverImageUrl'],
  ...
  coach: {
    editable: ['fullName', 'bio', 'nationality', 'currentClub', 'years', 'age', 'skills', 'languages', 'trophies', 'career', 'avatarUrl'],
  ...
  club: {
    editable: ['name', 'country', 'city', 'province', 'division', 'president', 'currentDirector', 'currentCoach', 'founded', 'bio', 'seeking', 'achievements', 'imageUrl'],
  ...
  agent: {
    editable: ['fullName', 'nationality', 'agencyName', 'players', 'countries', 'bio', 'career', 'markets', 'notableTransfers', 'avatarUrl'],
    required: ['fullName', 'nationality', 'bio'],
